 ...
 * @author adbellas
 */
public class ViewCoachCapacity extends javax.swing.JFrame {

    /**
     * Creates new form ViewCoachCapacity
     */
    public ViewCoachCapacity() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        coachInformationTable = new javax.swing.JTable();

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);

        logoutBtn.setText("Log out");

        coachInformationTable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jScrollPane1.setViewportView(coachInformationTable);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewCoachCapacity.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewCoachCapacity().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JTable coachInformationTable;
